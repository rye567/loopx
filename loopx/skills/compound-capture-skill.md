...
3. 如果有复用价值，生成 captured 决策，写明摘要、经验、预防措施、风险标签和适用范围；持久化字段继续使用 `summary`、`learning`、`prevention`、`risk_tags` 和 `applies_to`。
...
- captured 文档包含“摘要”“经验”“预防措施”，并能通过 `compound-learning.schema.json`。
- skipped 文档包含明确跳过原因。
